...
Em destaque na imagem, vê-se o dissipador, com a ponte de diodos parafusada mais à esquerda.  Logo a frente do retificador onda completa, pode-se ver o indutor de estrangulamento, o qual bloqueia altas frequências indesejadas. direita do indutor, vê-se o transformador que diminui a tensão de para o nível adequado às saídas utilizadas.  Para os resistores e capacitores foram componentes comuns, de tensão e potências de operação que variam de acordo com a necessidade. O tipo do capacitor também varia de acordo com a necessidade, utilizando-se os tipos de poliester, eletrolítico e tântalo.
...
Na fonte inversora, foram utilizados capacitores de poliester de alta tensão, resistores comuns de 1/4 W e 3 IGBTs 30A, 600V do modelo 1MBH50D, da marca Fuji. O transformador é um model comum de três fios, com razão de transformação de....
